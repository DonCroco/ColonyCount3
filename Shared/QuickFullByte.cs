...
namespace CC.Core
{
	public class QuickFillByte 
	{
		...
		public static void FloodFill(Point pos, byte[] pixels, Size size, byte readColor, byte writeColor, ICollection<Point> points)
		{
		...
		private static void LinearFill(int x, int y, byte[] pixels, int width, 
		                               byte readColor, byte writeColor, Queue<FloodFillRange> ranges, ICollection<Point> points)
		{
			byte testColor = readColor;
		...
		private static bool CheckPixel(byte[] pixels, int index, byte testColor) {
			return pixels[index] == testColor;
		}
		
		private static bool AddPixel(byte[] pixels, int index, short x, short y, byte writeColor, ICollection<Point> points) {
