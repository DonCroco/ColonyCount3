...
namespace CC.Core
{
	public class QuickFillUint 
	{
		...
		public static void FloodFill(Point pos, uint[] pixels, Size size, uint readColor, uint writeColor, ICollection<Point> points)
		{
		...
		private static void LinearFill(int x, int y, uint[] pixels, int width, 
		                               uint readColor, uint writeColor, Queue<FloodFillRange> ranges, ICollection<Point> points)
		{
			uint testColor = readColor;
		...
		private static bool CheckPixel(uint[] pixels, int index, uint testColor) {
			return pixels[index] == testColor;
		}
		
		private static bool AddPixel(uint[] pixels, int index, short x, short y, uint writeColor, ICollection<Point> points) {
